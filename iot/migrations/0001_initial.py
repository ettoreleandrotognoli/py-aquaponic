# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-04 13:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strategy', models.CharField(choices=[('iot.actuators.actuator.NullActuator', 'Null Actuator'), ('iot.actuators.parport.DataPin', 'Parallel Port Pin'), ('iot.actuators.mqtt.MqttDevice', 'Mqtt Remote Device')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('strategy', models.CharField(choices=[('iot.fusion.sampling.HighSampling', 'High Sampling'), ('iot.fusion.ldr.Lumen', 'Electric Tension to Lumen using a LDR'), ('iot.fusion.ldr.Lux', 'Electric Tension to Lux using a LDR')], max_length=255, verbose_name='Fusion strategy')),
                ('strategy_options', jsonfield.fields.JSONField(blank=True, default={}, null=True)),
