# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-30 19:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error', core.utils.models.DecimalField(default=0)),
                ('integral', core.utils.models.DecimalField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('strategy', models.CharField(choices=[('iot.fusion.sampling.HighSampling', 'High Sampling')], max_length=255, verbose_name='Fusion strategy')),
                ('strategy_options', jsonfield.fields.JSONField(blank=True, default={}, null=True)),
